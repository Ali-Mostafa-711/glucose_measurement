...
import GlucoseCard from "../../items/cards/GlucoseCard";
import useAxios from "../../items/hooks/useAxios";
import Doctors from "../../pages/about/aboutComponents/Doctors";
            ...
            <div className="bg-white shadow-xl rounded-2xl p-6 w-full transition hover:scale-[1.01]">
              ...
              <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {data.meals.map((meal, index) => (
                  <li
                    key={index}
                    className="shadow p-4 rounded-lg bg-gray-50 hover:scale-[1.02] transition"
                  >
